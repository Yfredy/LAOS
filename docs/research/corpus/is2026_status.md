...
## 摘要补全结果（2026-09-14 完成）

- 本轮补抓 1200 条：成功 1069，失败 131，成功率 89.1%。
- 全库摘要覆盖：1315/5507（23.9%）。
- 失败主因：ISCA 服务器 SSL UNEXPECTED_EOF（重试 3 次仍失败才标记 abstract_failed）。

| laos 相关主题 | 总数 | 有摘要 | 覆盖率 |
|---|---|---|---|
| emotion | 321 | 235 | 73.2% |
| edge | 567 | 451 | 79.5% |
| kws_vad | 113 | 82 | 72.6% |
| event | 67 | 61 | 91.0% |
| codec | 109 | 74 | 67.9% |
| enhance | 683 | 562 | 82.3% |
